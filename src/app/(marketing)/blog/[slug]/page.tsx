...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!post) {
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <p className="text-charcoal mb-8">The blog post you're looking for doesn't exist.</p>
  ...
  return (
    <article className="space-y-12">
      {/* Hero */}
      <section className="pt-10 pb-12 border-b border-charcoal/10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <p className="text-lg text-charcoal max-w-2xl leading-relaxed">{post.excerpt}</p>
      ...
      <section className="pb-10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg">
          {post.body && post.body.length > 0 ? (
            ...
            <p className="text-charcoal">Content coming soon.</p>
          )}
        </div>
      </section>
