      ...
      <div className="w-full px-6 lg:px-12 py-12">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                <span className="text-sm text-charcoal/60">CA DRE #01938067</span>
                <span className="text-sm text-charcoal/60">eXp Realty of California Inc. CA DRE #01878277</span>
              </div>
              {/* Social icons */}
              <div className="flex items-center gap-4 mt-1">
                <a href="https://www.instagram.com/hellolahome" target="_blank" rel="noopener noreferrer" className="text-charcoal/50 hover:text-charcoal transition-colors">
                ...
                <a href="https://www.facebook.com/ericzunkleyrealtor" target="_blank" rel="noopener noreferrer" className="text-charcoal/50 hover:text-charcoal transition-colors">
          ...
          <div className="mt-12 text-sm text-charcoal/50 font-sans leading-relaxed text-center">
            <p>&copy; {currentYear} Eric Zunkley. All content on this website is the property of Eric Zunkley or its respective copyright owners and partners, and is protected by US and international copyright laws.</p>
          </div>
